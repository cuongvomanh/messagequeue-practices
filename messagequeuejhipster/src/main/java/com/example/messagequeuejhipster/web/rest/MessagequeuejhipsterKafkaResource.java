...
@RestController
@RequestMapping("/api/messagequeuejhipster-kafka")
public class MessagequeuejhipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MessagequeuejhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MessagequeuejhipsterKafkaResource(KafkaProperties kafkaProperties) {
