...
import com.example.messagequeuejhipster.config.KafkaProperties;
...
class MessagequeuejhipsterKafkaResourceIT {
    ...
    void setup() {
        ...
        MessagequeuejhipsterKafkaResource kafkaResource = new MessagequeuejhipsterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/messagequeuejhipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/messagequeuejhipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
